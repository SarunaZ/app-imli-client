...
export type MealDropDownListQuery = { __typename?: 'Query', meals?: Maybe<Array<{ __typename?: 'Meal', id: string, name?: Maybe<string>, ingredients?: Maybe<Array<Maybe<{ __typename?: 'Ingredients', name: string }>>> }>> };
