...
export type ChoreCreateMutation = {
  __typename?: "Mutation";
  createChore: {
    __typename?: "Chore";
    id: string;
...
export type ChoreDeleteMutation = {
  __typename?: "Mutation";
  deleteChore?: { __typename?: "Null"; success?: boolean | null } | null;
};
...
export type MealMutationMutationVariables = Exact<{
  id?: InputMaybe<Scalars["String"]["input"]>;
  name: Scalars["String"]["input"];
  ingredients?: InputMaybe<
    Array<InputMaybe<IngredientInput>> | InputMaybe<IngredientInput>
  >;
  instructions?: InputMaybe<Scalars["String"]["input"]>;
}>;
...
export type EditMealMutationMutation = {
  __typename?: "Mutation";
  editMeal?: { __typename?: "Null"; success?: boolean | null } | null;
};
...
export type MealDeleteMutationMutation = {
  __typename?: "Mutation";
  deleteMeal?: { __typename?: "Null"; success?: boolean | null } | null;
};
...
export type AttachMealToProductMutation = {
  __typename?: "Mutation";
...
export type ProductListOrderMutationVariables = Exact<{
  newList?: InputMaybe<
    Array<InputMaybe<ProductInput>> | InputMaybe<ProductInput>
  >;
}>;

export type ProductListOrderMutation = {
  __typename?: "Mutation";
  updateListOrderMutation?: Array<{
    __typename?: "Product";
    id: string;
    name?: string | null;
    isDone?: boolean | null;
...
export type ProductListCancelMutationVariables = Exact<{
  [key: string]: never;
}>;

export type ProductListCancelMutation = {
  __typename?: "Mutation";
  cancelProductList?: { __typename?: "Null"; success?: boolean | null } | null;
};
...
export type ProductDeleteMutation = {
  __typename?: "Mutation";
  deleteProduct?: { __typename?: "Null"; success?: boolean | null } | null;
};
...
export type ProductRenameMutation = {
  __typename?: "Mutation";
  renameProduct: {
    __typename?: "Product";
    id: string;
...
export type ProductCompleteMutation = {
  __typename?: "Mutation";
  completeProduct: {
    __typename?: "Product";
    id: string;
...
export type UserDataQuery = {
  __typename?: "Query";
  userDashboard: { __typename?: "UserDashboard"; username?: string | null };
};
